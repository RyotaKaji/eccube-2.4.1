<?php /* Smarty version 2.6.13, created on 2015-11-14 00:00:54
...
<tr><td align="left" class="fs12"><input type="checkbox" id="skip" name="db_skip" <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_db_skip'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'on'): ?>checked<?php endif; ?>> <label for="skip">データベースの初期化処理を行わない</label></td></tr>
<?php endif; ?>
...
/img/install/next.jpg" width="105" height="24" alt="次へ進む" border="0" name="next" onClick="document.body.style.cursor = 'wait';">
        </td>
    </tr>
    <tr><td height="30"></td></tr>
</from>
