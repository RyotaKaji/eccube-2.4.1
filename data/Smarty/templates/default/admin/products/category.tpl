                        ...
                        <td align="center">
                            <table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="category_name" value="<!--{$arrForm.category_name|escape}-->" size="30" class="box30" maxlength="<!--{$smarty.const.STEXT_LEN}-->"/></td>
                                    </tr>
                                    <tr>
                                    <td align="right">説明：</td>
                                    <td><input type="text" name="description" value="<!--{$arrForm.description|escape}-->" size="30" class="box30" maxlength="<!--{$smarty.const.STEXT_LEN}-->"/></td>                                    
                                    </tr>
                                    <tr>
                                    <td></td>
                                    <td align="right">
