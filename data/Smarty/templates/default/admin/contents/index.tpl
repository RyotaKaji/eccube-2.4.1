							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										...
										<td bgcolor="#ffffff" width="600"><span class="red"><!--{$arrErr.start_year}--><!--{$arrErr.start_month}--><!--{$arrErr.start_day}--></span>
                                                                                        <select name="start_year">
												<option value="" selected>----</option>
												<!--{html_options values=$arrYear output=$arrYear selected=$selected_start_year}-->
											</select>年
                                                                                        <select name="start_month" >    
												<option value="" selected>--</option>
												<!--{html_options values=$arrMonth output=$arrMonth selected=$selected_start_month}-->
											</select>月
                                                                                        <select name="start_day" >
												<option value="" selected>--</option>
												<!--{html_options values=$arrDay output=$arrDay selected=$selected_start_day}-->
											</select>日
										</td>
									</tr>   
                                                                        <tr class="fs12n">
                                                                                <td bgcolor="#f2f1ec" width="78">掲載終了日</td>
										<td bgcolor="#ffffff" width="600"><span class="red"><!--{$arrErr.end_year}--><!--{$arrErr.end_month}--><!--{$arrErr.end_day}--></span>
                                                                                        <select name="end_year"> 
												<option value="" selected>----</option>
												<!--{html_options values=$arrYear output=$arrYear selected=$selected_end_year }-->
											</select>年
                                                                                        <select name="end_month" >
												<option value="" selected>--</option>
												<!--{html_options values=$arrMonth output=$arrMonth selected=$selected_end_month}-->
											</select>月
                                                                                        <select name="end_day" >
												<option value="" selected>--</option>
												<!--{html_options values=$arrDay output=$arrDay selected=$selected_end_day}-->
											</select>日
                                                                                </td>
                                                                        </tr>
								...
								<input type="hidden" name="rank" value="">
									...
									<tr bgcolor="<!--{if $list_data[data].news_id eq $news_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->" class="fs12">
										...
										<td width="" align="center"><!--{$list_data[data].cast_news_start_date|date_format:"%Y/%m/%d"}--></td>
                                                                                <td width="" align="center"><!--{$list_data[data].cast_news_end_date|date_format:"%Y/%m/%d"}--></td>
										<td width="">
