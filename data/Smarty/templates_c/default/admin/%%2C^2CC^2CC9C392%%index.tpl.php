<?php /* Smarty version 2.6.13, created on 2015-11-19 01:16:16
         compiled from design/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/index.tpl', 83, false),array('modifier', 'escape', 'design/index.tpl', 92, false),)), $this); ?>
<style type="text/css">
    div.dragged_elm {
        position:   absolute;
...
function init () {
	...
	<?php echo ((is_array($_tmp=$this->_tpl_vars['complate_msg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
<input type="hidden" name="page_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">
<input type="hidden" name="bloc_cnt" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['bloc_cnt'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">
	<tr valign="top">
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<tr class="fs12n">
								<td bgcolor="#f2f1ec" align="center" colspan=2>
									...
									<input type='button' value='プレビュー' name='preview' onclick="doPreview();" <?php if (((is_array($_tmp=$this->_tpl_vars['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '0' || ((is_array($_tmp=$this->_tpl_vars['exists_page'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '0'): ?>DISABLED<?php endif; ?> />
								</td>
							</tr>
						</table>
						<!--▲レイアウト編集　ここまで-->
...
" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['page_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
								...
								<td align="center" width=78 bgcolor="<?php if (((is_array($_tmp=$this->_tpl_vars['item']['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=$this->_tpl_vars['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))):  echo ((is_array($_tmp=@SELECT_RGB)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp));  else: ?>#ffffff<?php endif; ?>">
									<input type='button' value='メイン編集' name='page_edit' onclick="location.href='./main_edit.php?page_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'"  />
								</td>
								<td align="center" width=78 bgcolor="<?php if (((is_array($_tmp=$this->_tpl_vars['item']['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=$this->_tpl_vars['page_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))):  echo ((is_array($_tmp=@SELECT_RGB)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp));  else: ?>#ffffff<?php endif; ?>">
...
<?php $_from = ((is_array($_tmp=$this->_tpl_vars['tpl_arrBloc'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
        $this->_foreach['bloc_loop']['iteration']++;
?>
<div align=center target_id="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['target_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" did="<?php echo ((is_array($_tmp=$this->_foreach['bloc_loop']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="dragged_elm" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['target_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"
...
<input type="hidden" name="name_<?php echo ((is_array($_tmp=$this->_foreach['bloc_loop']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
">
<input type="hidden" name="id_<?php echo ((is_array($_tmp=$this->_foreach['bloc_loop']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
">
<input type="hidden" name="target_id_<?php echo ((is_array($_tmp=$this->_foreach['bloc_loop']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
">
<input type="hidden" name="top_<?php echo ((is_array($_tmp=$this->_foreach['bloc_loop']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
